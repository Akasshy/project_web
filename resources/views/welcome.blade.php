...
<body >
  ...
  <div  class="container-fluid vh-100">
    <div class="row h-100">
        <!-- Bagian Kiri: Logo -->
        <div style="" class="col-md-6 d-flex justify-content-center align-items-center">
                            ...
                            <div class="modal-body">
                                <form action="/register" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" style="border-bottom: 1px solid #7A1CAC " class="form-control" name="name" id="name" placeholder="Enter your name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" style="color: black" class="form-label">Email</label>
                                        <input type="email" style="border-bottom: 1px solid #7A1CAC " class="form-control" name="email" id="email" placeholder="Enter your email">
                                    </div>
                                    <div class="mb-3">
                                        <label for="password" style="color: black" class="form-label">Password</label>
                                        <input type="password" style="border-bottom: 1px solid #7A1CAC " class="form-control" name="password" id="password" placeholder="Enter your password">
                                    </div>
